...
from typing import TYPE_CHECKING, Optional, Union, Tuple, Any, List

from discord import EmbedField, Colour, Embed
...
class Utilities:
    ...
    def make_embed(
        ...
        embed = Embed(
            colour=color if color is not None else Colour.from_rgb(23, 56, 51),
            title=title,
